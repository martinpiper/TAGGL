...
Because it's a Windows application it needs to be able to emulate the ARM, so it uses Wei Qin's ARM emulator code with some tweaks to allow 26 Bit ARM emulation.
