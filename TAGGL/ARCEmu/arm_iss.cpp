...
void SIMIT_IMP(addi_imm_mode1_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + imm8);
...
void SIMIT_IMP(addi_rot_mode1_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + ((imm8>>(rotate<<1))|(imm8<<(32-(rotate<<1)))));
...
void SIMIT_IMP(add_lsl_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (READ_REG(rm)<<shift_imm));
...
void SIMIT_IMP(add_zero_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + 0);
...
void SIMIT_IMP(add_sign_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (BIT31(READ_REG(rm))?~0:0));
...
void SIMIT_IMP(add_asr_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + ((int32_t)(READ_REG(rm))>>shift_imm));
...
void SIMIT_IMP(add_rrx_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + ((READ_REG(rm)>>1)|(C_FLAG<<31)));
...
void SIMIT_IMP(add_ror_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (val32=READ_REG(rm), (val32>>shift_imm)|(val32<<(32-shift_imm))));
...
void SIMIT_IMP(add_lsl_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (tmp32<32)?(val32<<tmp32):0));
...
void SIMIT_IMP(add_asr_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (int32_t)val32>>(tmp32<32?tmp32:31)));
...
void SIMIT_IMP(add_ror_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (val32>>(tmp32&0x1f))|(val32<<(32-(tmp32&0x1f)))));
...
void SIMIT_IMP(adci_imm_mode1_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + imm8 + C_FLAG);
...
void SIMIT_IMP(adci_rot_mode1_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + ((imm8>>(rotate<<1))|(imm8<<(32-(rotate<<1)))) + C_FLAG);
...
void SIMIT_IMP(adc_lsl_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (READ_REG(rm)<<shift_imm) + C_FLAG);
...
void SIMIT_IMP(adc_zero_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + 0 + C_FLAG);
...
void SIMIT_IMP(adc_sign_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (BIT31(READ_REG(rm))?~0:0) + C_FLAG);
...
void SIMIT_IMP(adc_asr_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + ((int32_t)(READ_REG(rm))>>shift_imm) + C_FLAG);
...
void SIMIT_IMP(adc_rrx_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + ((READ_REG(rm)>>1)|(C_FLAG<<31)) + C_FLAG);
...
void SIMIT_IMP(adc_ror_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (val32=READ_REG(rm), (val32>>shift_imm)|(val32<<(32-shift_imm))) + C_FLAG);
...
void SIMIT_IMP(adc_lsl_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (tmp32<32)?(val32<<tmp32):0) + C_FLAG);
...
void SIMIT_IMP(adc_asr_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (int32_t)val32>>(tmp32<32?tmp32:31)) + C_FLAG);
...
void SIMIT_IMP(adc_ror_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) + (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (val32>>(tmp32&0x1f))|(val32<<(32-(tmp32&0x1f)))) + C_FLAG);
...
void SIMIT_IMP(sbci_imm_mode1_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) - imm8 - (1-C_FLAG));
...
void SIMIT_IMP(sbci_rot_mode1_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) - ((imm8>>(rotate<<1))|(imm8<<(32-(rotate<<1)))) - (1-C_FLAG));
...
void SIMIT_IMP(sbc_lsl_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) - (READ_REG(rm)<<shift_imm) - (1-C_FLAG));
...
void SIMIT_IMP(sbc_zero_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) - 0 - (1-C_FLAG));
...
void SIMIT_IMP(sbc_sign_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) - (BIT31(READ_REG(rm))?~0:0) - (1-C_FLAG));
...
void SIMIT_IMP(sbc_asr_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) - ((int32_t)(READ_REG(rm))>>shift_imm) - (1-C_FLAG));
...
void SIMIT_IMP(sbc_rrx_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) - ((READ_REG(rm)>>1)|(C_FLAG<<31)) - (1-C_FLAG));
...
void SIMIT_IMP(sbc_ror_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) - (val32=READ_REG(rm), (val32>>shift_imm)|(val32<<(32-shift_imm))) - (1-C_FLAG));
...
void SIMIT_IMP(sbc_lsl_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) - (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (tmp32<32)?(val32<<tmp32):0) - (1-C_FLAG));
...
void SIMIT_IMP(sbc_asr_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) - (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (int32_t)val32>>(tmp32<32?tmp32:31)) - (1-C_FLAG));
...
void SIMIT_IMP(sbc_ror_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, READ_REG_HINT(rn,rd) - (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (val32>>(tmp32&0x1f))|(val32<<(32-(tmp32&0x1f)))) - (1-C_FLAG));
...
void SIMIT_IMP(rsbi_imm_mode1_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, imm8 - READ_REG_HINT(rn,rd));
...
void SIMIT_IMP(rsbi_rot_mode1_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, ((imm8>>(rotate<<1))|(imm8<<(32-(rotate<<1)))) - READ_REG_HINT(rn,rd));
...
void SIMIT_IMP(rsb_lsl_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (READ_REG(rm)<<shift_imm) - READ_REG_HINT(rn,rd));
...
void SIMIT_IMP(rsb_zero_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, 0 - READ_REG_HINT(rn,rd));
...
void SIMIT_IMP(rsb_sign_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (BIT31(READ_REG(rm))?~0:0) - READ_REG_HINT(rn,rd));
...
void SIMIT_IMP(rsb_asr_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, ((int32_t)(READ_REG(rm))>>shift_imm) - READ_REG_HINT(rn,rd));
...
void SIMIT_IMP(rsb_rrx_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, ((READ_REG(rm)>>1)|(C_FLAG<<31)) - READ_REG_HINT(rn,rd));
...
void SIMIT_IMP(rsb_ror_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (val32=READ_REG(rm), (val32>>shift_imm)|(val32<<(32-shift_imm))) - READ_REG_HINT(rn,rd));
...
void SIMIT_IMP(rsb_lsl_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (tmp32<32)?(val32<<tmp32):0) - READ_REG_HINT(rn,rd));
...
void SIMIT_IMP(rsb_asr_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (int32_t)val32>>(tmp32<32?tmp32:31)) - READ_REG_HINT(rn,rd));
...
void SIMIT_IMP(rsb_ror_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (val32>>(tmp32&0x1f))|(val32<<(32-(tmp32&0x1f)))) - READ_REG_HINT(rn,rd));
...
void SIMIT_IMP(rsci_imm_mode1_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, imm8 - READ_REG_HINT(rn,rd) - (1-C_FLAG));
...
void SIMIT_IMP(rsci_rot_mode1_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, ((imm8>>(rotate<<1))|(imm8<<(32-(rotate<<1)))) - READ_REG_HINT(rn,rd) - (1-C_FLAG));
...
void SIMIT_IMP(rsc_lsl_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (READ_REG(rm)<<shift_imm) - READ_REG_HINT(rn,rd) - (1-C_FLAG));
...
void SIMIT_IMP(rsc_zero_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, 0 - READ_REG_HINT(rn,rd) - (1-C_FLAG));
...
void SIMIT_IMP(rsc_sign_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (BIT31(READ_REG(rm))?~0:0) - READ_REG_HINT(rn,rd) - (1-C_FLAG));
...
void SIMIT_IMP(rsc_asr_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, ((int32_t)(READ_REG(rm))>>shift_imm) - READ_REG_HINT(rn,rd) - (1-C_FLAG));
...
void SIMIT_IMP(rsc_rrx_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, ((READ_REG(rm)>>1)|(C_FLAG<<31)) - READ_REG_HINT(rn,rd) - (1-C_FLAG));
...
void SIMIT_IMP(rsc_ror_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (val32=READ_REG(rm), (val32>>shift_imm)|(val32<<(32-shift_imm))) - READ_REG_HINT(rn,rd) - (1-C_FLAG));
...
void SIMIT_IMP(rsc_lsl_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (tmp32<32)?(val32<<tmp32):0) - READ_REG_HINT(rn,rd) - (1-C_FLAG));
...
void SIMIT_IMP(rsc_asr_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (int32_t)val32>>(tmp32<32?tmp32:31)) - READ_REG_HINT(rn,rd) - (1-C_FLAG));
...
void SIMIT_IMP(rsc_ror_mode3_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), (val32>>(tmp32&0x1f))|(val32<<(32-(tmp32&0x1f)))) - READ_REG_HINT(rn,rd) - (1-C_FLAG));
...
void SIMIT_IMP(andis_imm_mode1_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (carry=C_FLAG,imm8);
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(andis_rot_mode1_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (rslt32=(imm8>>(rotate<<1))|(imm8<<(32-(rotate<<1))), carry=BIT31(rslt32), rslt32);
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_lsz_mode2_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (carry=C_FLAG, READ_REG(rm));
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_lsl_mode2_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (val32=READ_REG(rm), carry=BITn(val32, 32-shift_imm), val32<<shift_imm);
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_zero_mode2_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (carry=BIT31(READ_REG(rm)), 0);
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_lsr_mode2_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (val32=READ_REG(rm), carry=BITn(val32, shift_imm-1), val32>>shift_imm);
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_sign_mode2_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (val32=READ_REG(rm), carry=BIT31(val32), BIT31(val32)?~0:0);
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_asr_mode2_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (val32=READ_REG(rm), carry=BITn(val32, shift_imm-1), (int32_t)val32>>shift_imm);
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_rrx_mode2_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (val32=READ_REG(rm), carry=BIT0(val32), (val32>>1)|(C_FLAG<<31));
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_ror_mode2_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (val32=READ_REG(rm), carry=BITn(val32, shift_imm-1), (val32>>shift_imm)|(val32<<(32-shift_imm)));
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_lsl_mode3_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), carry=(tmp32==0)?C_FLAG:((tmp32>32)?0:BITn(val32,32-val32)), (tmp32<32)?(val32<<tmp32):0);
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_lsr_mode3_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), carry=(tmp32==0)?C_FLAG:((tmp32>32)?0:BITn(val32,tmp32-1)), (tmp32<32)?(val32>>tmp32):0);
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_asr_mode3_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), carry=(tmp32==0)?C_FLAG:((tmp32>31)?BIT31(val32):BITn(val32,tmp32-1)), (int32_t)val32>>(tmp32<32?tmp32:31));
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(ands_ror_mode3_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = READ_REG_HINT(rn,rd) & (tmp32=READ_REG(rs)&0xFF, val32=READ_REG(rm), carry=(tmp32==0)?C_FLAG:((tmp32&0x1f==0)?BIT31(val32):BITn(val32,(tmp32&0x1f)-1)), (val32>>(tmp32&0x1f))|(val32<<(32-(tmp32&0x1f))));
    if (rd==15)
        WRITE_CPSR(SPSR);
    else
		ASGN_NZC(rslt32, carry);
...
void SIMIT_IMP(mla_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rd, (uint32_t)((uint64_t)READ_REG(rm) * (uint64_t)READ_REG(rs) + READ_REG_HINT(rn,rd)));
...
void SIMIT_IMP(mla_s_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt32 = (uint32_t)((uint64_t)READ_REG(rm) * (uint64_t)READ_REG(rs) + READ_REG_HINT(rn,rd));
	ASGN_NZ(rslt32);
	WRITE_REG(rd, rslt32);
...
void SIMIT_IMP(smlal_) (emulator_t *emu, target_inst_t inst)
{
	...
	rslt64 = ((uint64_t)READ_REG_HINT(rn,rd)<<32) + (uint64_t)READ_REG(rd);
...
void SIMIT_IMP(ldt_imm_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rn, ufld?READ_REG_HINT(rn,rd)+imm12:READ_REG_HINT(rn,rd)-imm12);
	WRITE_REG(rd, rslt32);
...
void SIMIT_IMP(ldt_reg_lsl_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	WRITE_REG(rn, ufld?READ_REG_HINT(rn,rd)+offset:READ_REG_HINT(rn,rd)-offset);
	WRITE_REG(rd, rslt32);
...
void SIMIT_IMP(ld1_imm_p_) (emulator_t *emu, target_inst_t inst)
{
	...
	address = ufld?READ_REG_HINT(rn,rd)+imm12:READ_REG_HINT(rn,rd)-imm12;
	MMU_READ_WORD(address,&rslt32);
...
void SIMIT_IMP(ld1_reg_p_lsl_mode2_) (emulator_t *emu, target_inst_t inst)
{
	...
	offset = (READ_REG(rm)<<shift_imm);
	address = ufld?READ_REG_HINT(rn,rd)+offset:READ_REG_HINT(rn,rd)-offset;
	MMU_READ_WORD(address,&rslt32);
	if (fault){
		ABORT( DataAbortV );
	}
...
void SIMIT_IMP(mar_) (emulator_t *emu, target_inst_t inst)
{
	...
	/* XScale MAR insn.  Move two registers into accumulator.  */
		...
		emu->accumulator += (uint64_t)READ_REG_HINT(rn,rd)<<32;
	}
	else
		ABORT2(UndefinedInstrV);
